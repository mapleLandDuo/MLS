...
//        }
//
//        viewModel.commentCount.bind { _ in
//            self.commentTableView.reloadData()
//        }
//    }
// }
...
//                self.viewModel.commentCount.value = self.viewModel.comments.value?.count
////                print(self.viewModel.comments.value)
//            }
//        }
//    }
// }
...
//        // 레이아웃이 다시 그려지지 않는문제
//        print(viewModel.commentCount.value)
//        return viewModel.commentCount.value ?? 0
//    }
//
...
extension PostDetailViewController: UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        case 0:
            ...
            cell.bind(images: dummy)
            return cell
        case 1:
            guard let cell = tableView.dequeueReusableCell(withIdentifier: DetailPostCell.identifier, for: indexPath) as? DetailPostCell else { return UITableViewCell() }
            return cell
        case 2:
            guard let cell = tableView.dequeueReusableCell(withIdentifier: DetailCommentCell.identifier, for: indexPath) as? DetailCommentCell else { return UITableViewCell() }
            return cell
        default:
